                              ...
                              children: <Widget>[
                                TextFormField(
                                  decoration: InputDecoration(
                                    ...
                                    prefixIcon: const HugeIcon(icon: HugeIcons.strokeRoundedMail01, color: Colors.grey, size: 30.0),
                                ...
                                TextFormField(
                                  decoration: InputDecoration(
                                    ...
                                    labelStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.grey.shade600),
                                    floatingLabelBehavior: FloatingLabelBehavior.always,
                                    prefixIcon: const HugeIcon(icon: HugeIcons.strokeRoundedSquareLock01, color: Colors.grey, size: 30.0),
                                ...
                                TextFormField(
                                  decoration: InputDecoration(
                                    ...
                                    labelStyle: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.grey.shade600),
                                    floatingLabelBehavior: FloatingLabelBehavior.always,
                                    prefixIcon: const HugeIcon(icon: HugeIcons.strokeRoundedUser, color: Colors.grey, size: 30.0),
                                ...
                                Row(
                                  children: [
                                    const HugeIcon(icon: HugeIcons.strokeRoundedInformationCircle, color: Colors.orange, size: 28.0),
