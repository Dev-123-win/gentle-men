  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
        title: const ShimmerLoading.rectangular(height: 24, width: 120),
        backgroundColor: Colors.white,
        elevation: 0,
      ...
      child: Scaffold(
        ...
        body: LayoutBuilder(
          builder: (context, constraints) {
            ...
            final buttonPadding = isSmallScreen ? const EdgeInsets.symmetric(horizontal: 20, vertical: 12) : const EdgeInsets.symmetric(horizontal: 30, vertical: 15);
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      Share.share('Join Rewardly and earn rewards! Use my referral code: $referralCode', subject: 'Referral Code');
                    },
