      ...
      builder: (BuildContext context) {
        return Container(
          ...
          decoration: const BoxDecoration(
            color: kSurfaceColor,
            borderRadius: BorderRadius.vertical(top: Radius.circular(kDefaultBorderRadius * 2)),
                      ...
                      if (!_isReading)
                        Padding(
                          ...
                          child: ScaleTransition(
                            ...
                            child: const HugeIcon(icon: HugeIcons.strokeRoundedArrowRight01, color: kAccentColor),
                          ),
                        ),
                    ],
                  )
